...
- **`.github/workflows/`** — one workflow per scraper: `scrape-leaderboard.yml` (05/11/17/23 UTC), `scrape-masters.yml` (00/06/12/18 UTC — 4×/day, one hour after each leaderboard run), `scrape-diamond-mythic.yml` (07:30 UTC), `refresh-intelligence.yml` (08:30 UTC safety net). All have `workflow_dispatch`.
